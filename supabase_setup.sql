...
BEGIN
    ...
    -- 将回收的ID重新放回池中 (延迟3秒后变为available)
    -- 这里直接设为available, 前端控制回收逻辑
    UPDATE id_pool
